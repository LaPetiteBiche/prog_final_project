def welcome():
    ...
    print("------------------------------")
    print("1. Toys and Games, 2. Clothing, Shoes and Jewelry, 3. Sports, outdoor and Fitness, 4. Video Games, 5.Patio, Lawn and Garden, 6. Musical Instrument, 7.Tools and Home, 8. Electronics")
